...
local Window = Rayfield:CreateWindow({
   ...
   KeySettings = {
      ...
      Key = {"freeenter1"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})

local MainTab = Window:CreateTab("Home scrits", nil) -- Title, Image
...
local AntiDeathTab = Window:CreateTab("AntiDeath", nil) -- Title, Image

local Section = AntiDeathTab:CreateSection("AntiDeath")

local Button = AntiDeathTab:CreateButton({
   Name = "AntiVoid",
   Callback = function()
